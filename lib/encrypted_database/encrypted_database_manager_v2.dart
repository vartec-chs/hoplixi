...
class EncryptedDatabaseManagerV2 implements IEncryptedDatabaseManager {
  ...
  Future<String> _prepareDatabasePath(CreateDatabaseDto dto) async {
    ...
    if (dto.customPath != null) {
      ...
      logDebug(
        ...
        tag: 'EncryptedDatabaseManagerV2',
      );
    } else {
  ...
  Future<DatabaseState> createDatabase(CreateDatabaseDto dto) async {
    ...
    return await ErrorHandler.safeExecute(
      operation: operation,
      context: 'EncryptedDatabaseManagerV2',
      additionalData: {
        'name': dto.name,
  ...
  Future<DatabaseState> closeDatabase() async {
    logInfo('Закрытие базы данных', tag: 'EncryptedDatabaseManagerV2');
    ...
    try {
      ...
      logInfo('База данных успешно закрыта', tag: 'EncryptedDatabaseManagerV2');
  ...
  Future<void> dispose() async {
    logInfo(
      'Освобождение ресурсов EncryptedDatabaseManagerV2',
      tag: 'EncryptedDatabaseManagerV2',
    );
    ...
    try {
      ...
      _clearSensitiveData();
      logInfo(
        'Ресурсы EncryptedDatabaseManagerV2 освобождены',
        tag: 'EncryptedDatabaseManagerV2',
      );
    } catch (e) {
      logError(
